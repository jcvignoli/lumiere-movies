...
/* var lumiere_vars.lum_path passed from wp_localize_script to class-movie.php */
( function () {
	'use strict';

	const url_highslide =
		lumiere_vars.lum_path + 'assets/js/highslide/graphics/';
	const popup_border_colour = lumiere_vars.popup_border_colour;
	...
	hs.skin.contentWrapper =
		'<div class="highslide-header highslide-move" style="background-color:' +
		popup_border_colour +
		';"></div>' +
		'<div class="highslide-body highslide-move" style="background-color:' +
		popup_border_colour +
		';"></div>' +
		'<div class="highslide-footer highslide-resize" style="background-color:' +
		popup_border_colour +
		';"><div>';
