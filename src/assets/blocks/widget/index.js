...
const linkAutoTitleWidgetOption = '<a href="admin.php?page=lumiere_options&subsection=advanced#imdbautopostwidget" target="_blank">' + widget__( 'Lumière main advanced options' , 'lumiere-movies' ) + '</a>';
