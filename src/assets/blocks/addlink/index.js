( ( wp ) => {
	...
	const addlinkEl = wp.element.createElement;
	const addlinkBlockProps = wp.blockEditor.useBlockProps.blockProps;
	...
	var ButtonTagIMDb = ( addlinkBlockProps ) => {
		return addlinkEl(
			addlinkRichButton, {
				...
				isActive: addlinkBlockProps.isActive,
			}
		);
	};
