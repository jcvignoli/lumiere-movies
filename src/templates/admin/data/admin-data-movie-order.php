...
<div class="lumiere_wrap">
	...
	<div class="submit lumiere_sticky_boxshadow lumiere_align_center">
		...
		<input type="submit" class="button-primary" id="lumiere_update_data_movie_settings" name="lumiere_update_data_movie_settings" value="<?php esc_attr_e( 'Update settings', 'lumiere-movies' ); ?>" />&nbsp;&nbsp;
		<input type="submit" class="button-primary" id="lumiere_reset_data_movie_settings" name="lumiere_reset_data_movie_settings" value="<?php esc_attr_e( 'Reset settings', 'lumiere-movies' ); ?>" />
	</div>
