 ...
 * @phpstan-type OPTIONS_ADMIN_KEY 'imdbplugindirectory'|'imdbplugindirectory_partial'|'imdbpluginpath'|'imdburlpopups'|'imdbkeepsettings'|'imdburlstringtaxo'|'imdbcoversize'|'imdbcoversizewidth'|'imdbmaxresults'|'imdbpopuptheme'|'imdbpopuplarg'|'imdbpopuplong'|'imdbintotheposttheme'|'imdblinkingkill'|'imdbautopostwidget'|'imdblanguage'|'imdbdebug'|'imdbdebuglog'|'imdbdebuglogpath'|'imdbdebuglevel'|'imdbdebugscreen'|'imdbwordpress_bigmenu'|'imdbwordpress_tooladminmenu'|'imdbpopup_modal_window'|'imdbtaxonomy'|'imdbHowManyUpdates'|'imdbseriemovies'
 ...
 * @phpstan-type OPTIONS_CACHE_KEY 'imdbcachedir_partial'|'imdbstorecache'|'imdbusecache'|'imdbconverttozip'|'imdbusezip'|'imdbcacheexpire'|'imdbcachedetailsshort'|'imdbcachedir'|'imdbphotoroot'|'imdbphotodir'
 * @phpstan-type OPTIONS_WIDGET_KEY 'imdbwidgettitle'|'imdbwidgetpic'|'imdbwidgetruntime'|'imdbwidgetdirector'|'imdbwidgetcountry'|'imdbwidgetactor'|'imdbwidgetactornumber'|'imdbwidgetcreator'|'imdbwidgetrating'|'imdbwidgetlanguage'|'imdbwidgetgenre'|'imdbwidgetwriter'|'imdbwidgetproducer'|'imdbwidgetproducernumber'|'imdbwidgetkeyword'|'imdbwidgetprodcompany'|'imdbwidgetplot'|'imdbwidgetplotnumber'|'imdbwidgetgoof'|'imdbwidgetgoofnumber'|'imdbwidgetcomment'|'imdbwidgetquote'|'imdbwidgetquotenumber'|'imdbwidgettagline'|'imdbwidgettaglinenumber'|'imdbwidgetcolor'|'imdbwidgetalsoknow'|'imdbwidgetalsoknownumber'|'imdbwidgetcomposer'|'imdbwidgetsoundtrack'|'imdbwidgetsoundtracknumber'|'imdbwidgetofficialsites'|'imdbwidgetsource'|'imdbwidgetyear'|'imdbwidgettrailer'|'imdbwidgettrailernumber'|'imdbwidgetorder'|'imdbtaxonomycolor'|'imdbtaxonomycomposer'|'imdbtaxonomycountry'|'imdbtaxonomycreator'|'imdbtaxonomydirector'|'imdbtaxonomygenre'|'imdbtaxonomykeyword'|'imdbtaxonomylanguage'|'imdbtaxonomyproducer'|'imdbtaxonomyactor'|'imdbtaxonomywriter'
