			...
			<div class="helpdiv">
				...
				<blockquote class="lumiere_bloquote_help lum_align_left">
					&lt;form action="" method="post" method="get" id="searchmovie" &gt<br>
						...
						&lt;input type="text" id="&lt;?php echo Get_Options::LUM_SEARCH_MOVIE_QUERY_STRING; ?&gt;" name="&lt;?php echo Get_Options::LUM_SEARCH_MOVIE_QUERY_STRING; ?&gt;" &gt<br>
				...
				<blockquote class="lumiere_bloquote_help lum_align_left">
					...
					if ( (isset ($_GET[ Get_Options::LUM_SEARCH_MOVIE_QUERY_STRING ])) && (!empty ($_GET[ Get_Options::LUM_SEARCH_MOVIE_QUERY_STRING ])) ){<br>
						$search_sanitized = isset($_GET[ Get_Options::LUM_SEARCH_MOVIE_QUERY_STRING ]) ? sanitize_text_field( $_GET[ Get_Options::LUM_SEARCH_MOVIE_QUERY_STRING] ) : NULL;<br>
