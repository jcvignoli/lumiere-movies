...
$lumiere_admin_page_help_compatibility = get_transient( 'admin_template_pass_vars' )[4];
$lumiere_admin_page_help_changelog = get_transient( 'admin_template_pass_vars' )[5];
?>
