 ...
 *
 * @extends Parent_Module<'prodCompany', array{name:string,id:string,country:string,attribute:string,year:int}[], \Lumiere\Vendor\Imdb\Title>
 */
final class Movie_Prodcompany extends Parent_Module {
