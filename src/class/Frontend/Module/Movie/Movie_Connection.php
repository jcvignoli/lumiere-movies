 ...
 *
 * @extends Parent_Module<'connection', array<array<array{titleId: string|null, titleName: string|null, titleType: string|null, year: string|null, endYear: string|null, seriesName: string|null, description: string|null}>>, \Lumiere\Vendor\Imdb\Title>
 */
final class Movie_Connection extends Parent_Module {
