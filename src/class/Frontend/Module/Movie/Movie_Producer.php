 ...
 * @phpstan-extends Parent_Module<'producer', CreditsArrayDef, \Lumiere\Vendor\Imdb\Title>
 * @phan-type CreditsArrayDefPhan = array<int, array{imdb: string, name: string, jobs?: array<int, string>}>
 * @phan-extends Parent_Module<'producer', CreditsArrayDefPhan, \Lumiere\Vendor\Imdb\Title>
 */
final class Movie_Producer extends Parent_Module implements Interface_Movie_Taxonomy {
