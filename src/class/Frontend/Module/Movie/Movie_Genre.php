 ...
 *
 * @extends Parent_Module<'genre', array<array-key, array{mainGenre: string|null, subGenre: list<string>}>, \Lumiere\Vendor\Imdb\Title>
 */
final class Movie_Genre extends Parent_Module implements Interface_Movie_Taxonomy {
