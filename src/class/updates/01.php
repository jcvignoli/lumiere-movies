...
class Lumiere_Update_File_01 extends \Lumiere\Updates {
	...
	protected function lumiere_run_local_update (): void {
		...
		if ( true === $this->lumiere_remove_options( \Lumiere\Settings::get_compat_data_tablename(), 'imdbwidgetcommentsnumber' ) ) {
		...
		if ( true === $this->lumiere_add_options( \Lumiere\Settings::get_compat_data_tablename(), 'imdbintotheposttheme', 'grey' ) ) {
