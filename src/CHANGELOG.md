...
* [bug] Inside the popups, the links did not include the Polylang plugin lang, so it wasn't translated
* [technical] Better explained the purposed of language in advanced options, displaying the full language
* [technical] Less files for update (removed 19 files in update folder, rewritten update process)
...
* [bug] Search person/movie id popup window wasn't working on translated WordPress
...
* [technical] Widget gutenberg block compatible with api version 3 (all blocks are now compatible with api v3)
...
* [technical] array_contains_term() in class utils was not escaping special characters provided in array of URLs. Made the function more versatile, using it in Core class.
