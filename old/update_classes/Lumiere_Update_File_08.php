 ...
 */
final class Lumiere_Update_File_08 extends \Lumiere\Updates {
	...
	protected function lumiere_run_local_update (): void {
		 ...
		 * Obsolete
		 */
		if ( true === $this->lumiere_remove_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetonpage' ) ) {
		 ...
		 * Obsolete
		 */
		if ( true === $this->lumiere_remove_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetonpost' ) ) {
		 ...
		 * Singularizing items
		 */
		if ( true === $this->lumiere_remove_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetgoofsnumber' ) ) {
		...
		if ( true === $this->lumiere_add_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetgoofnumber', false ) ) {
		 ...
		 * Singularizing items
		 */
		if ( true === $this->lumiere_remove_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetquotesnumber' ) ) {
		...
		if ( true === $this->lumiere_add_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetquotenumber', false ) ) {
		 ...
		 * Singularizing items
		 */
		if ( true === $this->lumiere_remove_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgettaglinesnumber' ) ) {
		...
		if ( true === $this->lumiere_add_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgettaglinenumber', false ) ) {
		 ...
		 */
		if ( true === $this->lumiere_remove_options( Get_Options_Movie::get_data_tablename(), 'imdbtaxonomytitle' ) ) {
		 ...
		 */
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgettitle', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetpic', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetruntime', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetdirector', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetcountry', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetactor', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetcreator', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetrating', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetlanguage', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetgenre', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetwriter', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetproducer', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetkeyword', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetprodcompany', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetplot', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetgoof', '1' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetcomment', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetquote', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgettagline', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetcolor', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetalsoknow', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetcomposer', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetsoundtrack', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetofficialsites', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetsource', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgetyear', '0' );
		$this->lumiere_update_options( Get_Options_Movie::get_data_tablename(), 'imdbwidgettrailer', '0' );
		$this->logger->log?->debug( '[updateVersion' . (string) self::LUMIERE_NUMBER_UPDATE . '] Maybe updated imdbwidget* vars to be strings instead of bools' );
		...
		$this->logger->log?->debug( '[updateVersion' . (string) self::LUMIERE_NUMBER_UPDATE . "] Process of deleting taxonomy $filter_taxonomy started" );
		...
		if ( $taxo_terms instanceof \WP_Error ) {
			$this->logger->log?->error( '[updateVersion' . (string) self::LUMIERE_NUMBER_UPDATE . '] Invalid terms: ' . $taxo_terms->get_error_message() );
			return;
		}
		...
		foreach ( $taxo_terms as $taxo_term ) {
			...
			if ( $term_id > 0 ) {
				...
				$this->logger->log?->debug( '[updateVersion' . (string) self::LUMIERE_NUMBER_UPDATE . '] Taxonomy: term ' . $term_name . ' in ' . $term_taxonomy . ' deleted.' );
		...
		$this->logger->log?->debug( '[updateVersion' . (string) self::LUMIERE_NUMBER_UPDATE . "] Taxonomy $filter_taxonomy processed." );
