...
class DataDetailsCest {
	...
	public function checkDataDeactivation( AcceptanceTester $I ) {
		...
		$I->dontSeeInSource('</span></i>, Lux aeterna <i>(1966)</i> <i>Music by 
			<a class="lum_link_make_popup lum_link_with_people" id="link-0509893" data-modal_window_nonce="');
		$I->dontSee('Trailers');
	...
	public function checkDataActivation(AcceptanceTester $I) {
		...
		$I->see('Ramin Djawadi');
		$I->see('Soundtracks');
		$I->seeInSource('</span></i>, Lux aeterna <i>(1966)</i> <i>Music by 
			<a class="lum_link_make_popup lum_link_with_people" id="link-0509893" data-modal_window_nonce="');
		$I->see('Trailers');
