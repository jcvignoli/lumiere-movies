( function ( wp ) {
	...
	const iconLumiereLink = el('svg', { width: 20, height: 20, viewBox: "0 0 350 350" },
		el( 'path', 
	...
	const iconLumiereWindow = el('svg', { width: 20, height: 20, viewBox: "0 0 1200 1200" },
		el( 'path', 
	...
	wp.richText.registerFormatType( 'lumiere/buttons-tag-imdb', 
		{	
			title: 'Add IMDb link',
			tagName: 'span',
	...
	wp.richText.registerFormatType( 'lumiere/buttons-open-search-imdb', 
		{
			title: 'Open search IMDB ID',
