...
v.3.10.2
* [bug] In some rare circonstances, two movies in widget were displayed. (fix class widget frontpage, added array_search() to better filter arrays)
* [bug] Better PHP 8.2 compatibility (function lumiere_parse_spans() returns string instead of null)
* [technical] Lumière! is not executed in feeds anymore
