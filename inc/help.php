...
?>
	...
	<div class="postbox-container" class="imdblt_float_right">
		<div id="right-sortables" class="meta-box-sortables">
			...
			<strong>1</strong>. <?php esc_html_e( 'visit', 'lumiere-movies'); ?> <a href="<?php esc_url( IMDBHOMEPAGE ) ?>">Lumière website</a> <?php esc_html_e( 'to ask for help. ', 'lumiere-movies'); ?><br />
	...
	<div class="postbox-container" class="imdblt_float_left">
		...
		<strong>5</strong>. <?php esc_html_e( "help me to improve the plugin.", 'lumiere-movies'); ?> <?php esc_html_e( "Report at the development", 'lumiere-movies'); ?> <a href="https://github.com/jcvignoli/lumiere-movies">GIT</a>'s <?php esc_html_e( 'website', 'lumiere-movies'); ?> <br />
...
function lumiere_help_plb_function () {
	...
	<div class="helpdiv">
		...
		<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-1.jpg"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="right" width="55%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-1.jpg"); ?>" alt="screenshot Link creator" /></a>
...
function lumiere_help_w_function () {
	...
	<div class="helpdiv">
		...
		<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-3.jpg"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="right" width="50%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-3.jpg"); ?>" alt="<?php esc_html_e( 'key and value for custom fields', 'lumiere-movies'); ?>" /></a>
	...
	<div class="helpdiv">
		<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-5.jpg"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="left" width="50%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-5.jpg"); ?>" alt="<?php esc_html_e( 'Lumiere Movies widget', 'lumiere-movies'); ?>" /></a>
...
function lumiere_help_itp_function () {
	...
	<div class="helpdiv">
		...
		<a href="<?php echo esc_url ($imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-2.jpg"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="right" width="50%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-2.jpg"); ?>" alt="<?php esc_html_e( 'Lumiere Movies widget', 'lumiere-movies'); ?>" /></a>
	...
	<div class="helpdiv">
		...
		<div align="center"><a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-8.jpg"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img width="90%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . ".wordpress-org/screenshot-8.jpg"); ?>" alt="<?php esc_html_e( 'Lumiere Movies Inside a post', 'lumiere-movies'); ?>" /></a></div>
...
function lumiere_help_adminbigmenu_function () {
	...
	<div class="helpdiv">
		<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/imdblt_menubig.jpg"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="right" width="10%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/imdblt_menubig.jpg"); ?>" alt="imdblt big menu" /></a>
	...
	<div class="helpdiv">
		<a href="<?php echo $imdb_admin_values['imdbplugindirectory']; ?>pics/imdblt_menubig_ozh.jpg" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="left" width="20%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/imdblt_menubig_ozh.jpg"); ?>" alt="imdblt big menu with Admin Drop Down Menu plugin" /></a>
...
function lumiere_help_usetaxonomy_function () {
	...
	<div class="helpdiv">
		...
		<div align="center">
			<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/taxonomy_details.png"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="center" width="60%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/taxonomy_details.png"); ?>" alt="taxonomy details" /></a>
		</div>
	</div>
	<div class="helpdiv">
	...
	<div class="helpdiv">
		...
		<div align="center">
		<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/taxonomy_newmenu.png"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="center" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/taxonomy_newmenu.png"); ?>" alt="taxonomy new options" /></a>
		</div>
	</div>
	...
	<div class="helpdiv">
		...
		<?php esc_html_e( "To fully enjoy this feature, copy the file in Lumiere Movies folder 'theme/taxonomy-genre.php' to your 'theme' folder. Customize this page according to your tastes and theme design. The design is the same as (ie) the tag.php file.", 'lumiere-movies'); ?><br />
		<div align="center">
			<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/taxonomy.png"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="center" width="80%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/taxonomy.png"); ?>" alt="taxonomy result" /></a>
		</div>
	</div>
...
function lumiere_help_autowidget_function () {
	...
	<div class="helpdiv">
		...
		<div align="center">
			<a href="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/auto-widget.png"); ?>" title="<?php esc_html_e( 'click to get a larger picture', 'lumiere-movies'); ?>"><img align="center" width="80%" src="<?php echo esc_url( $imdb_admin_values['imdbplugindirectory'] . "pics/auto-widget.png"); ?>" alt="auto widget option" /></a>
		</div>
	</div>
