...
8. Piece of code needed in order to display movie's data "inside a post" [Lumiere Movies inside a post tag](https://ps.w.org/lumiere-movies/assets/screenshot-8.jpg)
9. Help section contains many tips and how-to [Help section](https://ps.w.org/lumiere-movies/assets/screenshot-9.jpg)
